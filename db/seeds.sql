-- Parties must be created first or the insert statement will fail due to the foreign key constraint in candidates
...
VALUES
  ...
  ("Heroes of HTML", "Want to see a smock-up turn into an actual webpage in a matter of minutes? Well, the Heroes of HTML can get it done in a matter of seconds."),
